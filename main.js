...
function attachHospitals(hospitals) {
    ...
    hospitalDiv.html('');
    hospitalCountDiv.html(`<h2>There are <b>${hospitals.length}</b> Scary Hospitals in ${stateSelect.val()}<h2>`);
...
function createTemplate(hospital) {
    return
        `<div class='twelve columns hospital_box'>
